...
<div class="container mx-auto my-5">
    ...
    <div class="relative rounded-lg flex flex-col md:flex-row items-center md:shadow-xl md:h-72">
        ...
        <div class="z-0 order-1 md:order-2 relative w-full md:w-2/5 h-80 md:h-full overflow-hidden rounded-lg md:rounded-none md:rounded-r-lg">
            <div class="absolute inset-0 w-full h-full object-fill object-center bg-blue-400 bg-opacity-30 bg-cover bg-bottom" style="background-image: url( https://pbs.twimg.com/profile_images/1266448782935224320/t4plm6AG_400x400.jpg ); background-blend-mode: multiply;"></div>
            <div class="md:hidden absolute inset-0 h-full p-6 pb-6 flex flex-col-reverse justify-start items-start bg-gradient-to-b from-transparent via-transparent to-gray-900">
                <h3 class="w-full font-bold text-2xl text-white leading-tight mb-2">Life is too short. Let's do this.</h3>
                <h4 class="w-full text-xl text-gray-100 leading-tight">ポートフォリオっぽい何か</h4>
            </div>
        ...
        <div class="z-10 order-2 md:order-1  md:w-3/5 flex items-center -mt-6 md:mt-0">
            <div class="" style="margin-left:20px">
               <h4 class="hidden md:block text-xl text-gray-400">ポートフォリオっぽい何か</h4>
                <h3 class="hidden md:block font-bold text-2xl text-gray-700">Life is short. Let's do this.</h3>
            </div>
    ...
    <div>
            ...
            <div class="container mx-auto px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center -mx-2">
                        ...
                        <a class="flex items-center mx-2 text-gray-800 hover:text-indigo-600" href="https://twitter.com/godzhigella">
                        ...
                        <a class="flex items-center mx-2 text-gray-800 hover:text-indigo-600" href="https://github.com/higedamc">
                            <svg class="h-5 w-5 sm:h-6 sm:w-6 fill-current" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
        ...
        <section class="bg-white mt-20">
            <div class="max-w-2xl px-6 text-center mx-auto">
                <h2 class="text-3xl font-semibold text-gray-800">Hi, <span class="bg-indigo-600 text-white rounded px-1">I’m Kohei</span> . Nice to meet you.</h2>
        ...
        <section class="bg-gray-800 pattern py-20">
            <div class="max-w-5xl px-6 mx-auto text-center">
                ...
                <p class="text-gray-400 mt-4">起業家 / 通・翻訳・発音矯正家 / Cypherpunk/ 元CoinTelegraph Japan Editing & Publishing Lead / BTC & WireGuard狂 / 元シーシャ屋経営者</p>
            </div>
        </section>
